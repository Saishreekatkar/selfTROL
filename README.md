SelfTROl is an self Improvement App for android which prevents users from being controlled by social media apps. it measures app usage of the phone and displays all apps. 
